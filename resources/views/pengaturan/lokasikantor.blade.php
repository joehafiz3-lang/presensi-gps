...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Pengaturan Lokasi</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/pengaturan/updatelokasikantor" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        <span class="input-icon-addon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-radar-2">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
