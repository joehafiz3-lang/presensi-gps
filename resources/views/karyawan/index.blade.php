                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            $path = \Illuminate\Support\Facades\Storage::url('uploads/karyawan/'.$d->foto);
                                            @endphp
                                            <tr>
                                                ...
                                                <td>
                                                    @if (empty($d->foto))
                                                    <img src="{{ asset('assets/img/nophoto.png') }}" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($d->nama_lengkap) }}&background=0284c7&color=fff';" class="avatar" alt="no photo">
                                                    @else
                                                    <img src="{{ url($path) }}" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($d->nama_lengkap) }}&background=0284c7&color=fff';" class="avatar" alt="foto karyawan">
                                                    @endif
                                                </td>
                                                <td>{{ $d->nama_dept }}</td>
                                                <td>
