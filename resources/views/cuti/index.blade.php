                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="nama_cuti" value="" class="form-control" name="nama_cuti" placeholder="Nama Cuti">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="jml_hari" value="" class="form-control" name="jml_hari" placeholder="Jumlah Hari">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
